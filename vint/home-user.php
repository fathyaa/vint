    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <br>
          <a class="btn btn-primary btn-raised btn-lg" href='selling.php?<?php echo "u_id=$user_id" ?>'>SELL YOURS
          </a>
        </div>
      </div>
    </div>
            ...
            ?>
              <div class="col-md-3 mx-auto">
                <div class="card" style="width: 15rem;">
                    <a href='product-detail.php?<?php echo "product_id=$product_id" ?>'>
            ...
            <div class="col-md-4">
              <div class="team-player">
                <div class="card card-plain">
                  ...
                  <h4 class="card-title">Full Name
                    <br>
                    <small class="card-description text-muted">@username</small>
                  </h4>
                  <div class="card-body">
